...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Like.twitter'
        db.add_column('cmsplugin_like', 'twitter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Like.pinterest'
        db.add_column('cmsplugin_like', 'pinterest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Like.email'
        db.add_column('cmsplugin_like', 'email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Like.twitter'
        db.delete_column('cmsplugin_like', 'twitter')

        # Deleting field 'Like.pinterest'
        db.delete_column('cmsplugin_like', 'pinterest')

        # Deleting field 'Like.email'
        db.delete_column('cmsplugin_like', 'email')
